...
LUAI_FUNC lu_byte nluaP_getopmode(lua_State *L, OpCode m);
LUAI_FUNC lu_byte nluaP_getbmode(lua_State *L, OpCode m);
LUAI_FUNC lu_byte nluaP_getcmode(lua_State *L, OpCode m);
LUAI_FUNC lu_byte nluaP_testamode(lua_State *L, OpCode m);
LUAI_FUNC lu_byte nluaP_testtmode(lua_State *L, OpCode m);
